...
// requring shortcode generator file
require_once('includes/shortcode.php');

// requiring TinyMCE button generator file
require_once('includes/tmce_generator.php');

// requiring widget generator file

require_once('includes/widget_generator.php');